...
class ExpandedFixtureWriteHandleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $handle = new ExpandedFixtureWriteHandle($stream, 'foo', $this->renderer, $this->isolator);
    ...
    {
        $handle = new ExpandedFixtureWriteHandle(null, 'foo', null, $this->isolator);
        $handle->close();
    ...
    {
        $stream = $this->streamFixture();
        $handle = new ExpandedFixtureWriteHandle($stream, null, null, $this->isolator);
        $handle->close();
    ...
    public function testCloseFailureFcloseError()
    {
        ...
        $handle = new ExpandedFixtureWriteHandle($this->streamFixture(), null, null, $this->isolator);
