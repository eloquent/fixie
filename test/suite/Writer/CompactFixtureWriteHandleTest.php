...
class CompactFixtureWriteHandleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $handle = new CompactFixtureWriteHandle($stream, 'foo', $this->renderer, $this->isolator);
    ...
    {
        $handle = new CompactFixtureWriteHandle(null, 'foo', null, $this->isolator);
        $handle->close();
    ...
    {
        $stream = $this->streamFixture();
        $handle = new CompactFixtureWriteHandle($stream, null, null, $this->isolator);
        $handle->close();
    ...
    public function testCloseFailureFcloseError()
    {
        ...
        $handle = new CompactFixtureWriteHandle($this->streamFixture(), null, null, $this->isolator);
